...
| Static analysis                    | [![workflow scq badge](https://sonarcloud.io/api/project_badges/measure?project=drcandacemakedamoore_dissector&metric=alert_status)](https://sonarcloud.io/dashboard?id=drcandacemakedamoore_dissector) |
| Coverage                           | [![workflow scc badge](https://sonarcloud.io/api/project_badges/measure?project=drcandacemakedamoore_dissector&metric=coverage)](https://sonarcloud.io/dashboard?id=drcandacemakedamoore_dissector) || Documentation                      | [![Documentation Status](https://readthedocs.org/projects/dissector/badge/?version=latest)](https://dissector.readthedocs.io/en/latest/?badge=latest) || **GitHub Actions**                 | &nbsp; |
